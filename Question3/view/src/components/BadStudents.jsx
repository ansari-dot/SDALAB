...
const BadStudents = () => {
  ...
  useEffect(() => {
    axios
      ...
      .catch((err) => {
        console.error("Error fetching students needing improvement:", err);
  ...
  return (
    <div style={styles.container}>
      {students.length === 0 ? (
        <p style={styles.empty}>No students needing improvement found.</p>
      ) : (
            ...
            <tbody>
              {students.map((student, index) => (
                <tr key={index} style={styles.tr}>
                  ...
                  <td style={styles.td}>
                    <span style={styles.badCgpa}>{student.cgpa}</span>
                  </td>
                </tr>
              ))}
            </tbody>
